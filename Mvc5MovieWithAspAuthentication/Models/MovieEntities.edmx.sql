...
-- --------------------------------------------------
-- Date Created: 01/15/2018 23:20:34
-- Generated from EDMX file: C:\src\Mvc5MovieWithAspAuthenticationSln\Mvc5MovieWithAspAuthentication\Models\MovieEntities.edmx
-- --------------------------------------------------
...
-- Creating table 'C__MigrationHistory2'
CREATE TABLE [dbo].[C__MigrationHistory2] (
    [MigrationId] nvarchar(150)  NOT NULL,
    [ContextKey] nvarchar(300)  NOT NULL,
    [Model] varbinary(max)  NOT NULL,
    [ProductVersion] nvarchar(32)  NOT NULL
...
-- Creating table 'C__MigrationHistory3'
CREATE TABLE [dbo].[C__MigrationHistory3] (
    [MigrationId] nvarchar(150)  NOT NULL,
    [ContextKey] nvarchar(300)  NOT NULL,
    [Model] varbinary(max)  NOT NULL,
    [ProductVersion] nvarchar(32)  NOT NULL
...
-- Creating primary key on [MigrationId], [ContextKey] in table 'C__MigrationHistory2'
ALTER TABLE [dbo].[C__MigrationHistory2]
ADD CONSTRAINT [PK_C__MigrationHistory2]
    PRIMARY KEY CLUSTERED ([MigrationId], [ContextKey] ASC);
GO

-- Creating primary key on [MigrationId], [ContextKey] in table 'C__MigrationHistory3'
ALTER TABLE [dbo].[C__MigrationHistory3]
ADD CONSTRAINT [PK_C__MigrationHistory3]
    PRIMARY KEY CLUSTERED ([MigrationId], [ContextKey] ASC);
GO
